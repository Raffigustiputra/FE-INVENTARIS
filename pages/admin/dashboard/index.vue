<template>
  <div>
    ...
    <div v-else class="">
      <div
        class="border-b mt-3 flex py-4 items-center border-[#D9D9D9] border-t w-full"
      >
      ...
      <div class="w-full flex">
        <!-- left section -->
        <div
          class="w-9/12 border-r border-[#D9D9D9] h-auto px-2 overflow-y-auto"
        >
          <!-- over view Section -->
...
import BarChartSkeleton from "~/components/skeleton/barChartSkeleton.vue";
import CardSkeleton from "~/components/skeleton/cardSkeleton.vue";
import PieChartSkeleton from "~/components/skeleton/pieChartSkeleton.vue";
