  ...
  >
    ...
    <div class="relative z-10 mx-4 sm:mx-12 lg:mx-24 w-full">
      <div class="mb-6">
        ...
        <div
          class="w-full sm:w-8/12 lg:w-5/12 mt-2 text-xs sm:text-sm lg:text-base"
        >
          <p>
            A Data and Management System for Inventory Management. Monitor,
            manage, and integrate all inventory data more easily and quickly.
            Please log in to start using the available features.
          </p>
        </div>
      </div>
      ...
      <form
        ...
        class="w-full sm:w-10/12 md:w-6/12 lg:w-5/12 pt-4 pb-8 rounded-xl bg-white"
      >
        <div class="w-full text-center">
          <h1 class="font-semibold text-sm sm:text-base">
            Log in to start using WikVentory
          </h1>
        </div>
