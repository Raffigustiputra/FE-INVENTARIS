...
<template>
    ...
    <div
        class="relative w-full h-screen flex flex-col lg:flex-row items-center justify-center overflow-hidden px-4 sm:px-8">
        <div class="absolute right-4 top-6 sm:right-8 sm:top-10">
            <div class="flex items-center relative gap-2">
                <img src="/public/images/wv-blue.png" alt="Logo wv-blue" class="size-16 sm:size-20 object-contain" />
                <img src="/images/wikrama-logo.png" alt="Logo Wikrama" class="size-16 sm:size-20 object-contain" />
            </div>
        </div>
        ...
        <!-- Konten utama -->
        <div class="relative z-10 mx-4 sm:mx-12 lg:mx-24 w-full">
            <div class="mb-6">
                <div class="font-bold text-3xl">
                    <h1>Welcome to WikVentory</h1>
                </div>
                <div class="w-full sm:w-8/12 lg:w-5/12 mt-2 text-xs sm:text-sm lg:text-base">
                    <p>
            ...
            <form @submit.prevent="login" class="w-full sm:w-10/12 md:w-6/12 lg:w-5/12 pt-4 pb-8 rounded-xl bg-white">
                ...
                <div class="mx-4 flex flex-col gap-1">
                    ...
                    <input v-model="authStore.input.username" type="text" placeholder="Input your username..."
                ...
                <div class="mx-4 mt-4 flex flex-col gap-1 relative">
                    ...
                    <input v-model="authStore.input.password" :type="typeInputPassword"
                    ...
                    <button type="button" @click="switchVisibility"
                        class="absolute right-3 top-9 sm:top-11 transform -translate-y-1/2 hover:cursor-pointer">
                        <svg v-if="switchEye === true" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 text-[#D5D5D5]">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M3.98 8.223A10.477 10.477 0 0 0 1.934 12C3.226 16.338 7.244 19.5 12 19.5c.993 0 1.953-.138 2.863-.395M6.228 6.228A10.451 10.451 0 0 1 12 4.5c4.756 0 8.773 3.162 10.065 7.498a10.522 10.522 0 0 1-4.293 5.774M6.228 6.228 3 3m3.228 3.228 3.65 3.65m7.894 7.894L21 21m-3.228-3.228-3.65-3.65m0 0a3 3 0 1 0-4.243-4.243m4.242 4.242L9.88 9.88" />
                        </svg>
                        <svg v-else xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            stroke-width="1.5" stroke="currentColor" class="size-6 text-[#D5D5D5]">
                            <path stroke-linecap="round" stroke-linejoin="round"
