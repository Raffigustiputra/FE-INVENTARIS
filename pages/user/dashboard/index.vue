<template>
  ...
  <div>
    ...
    <div class="flex w-full">
      <div class="w-9/12">
        ...
        <div class="flex">
          ...
          <div class="w-full border-r border-[#D9D9D9] h-auto overflow-y-auto">
            ...
            <div v-else class="mt-4 border-t border-[#D9D9D9]">
      ...
      <div class="w-3/12">
        <div
          class="w-full mt-3 min-h-[28.5rem] border-b border-[#D9D9D9] border-t"
        >
        ...
        <!-- Quick Borrowing Section -->
        <div class="w-full">
          <div class="my-6 flex justify-center">
            <h1 class="font-semibold text-lg">Quick Borrowing</h1>
          </div>

          <!-- Show skeleton while loading -->
          <SkeletonQuickBorrowing v-if="loading" />

          <!-- Show actual form when loaded -->
          <div v-else class="flex flex-col mx-4 gap-4">
            <!-- Item Type Label -->
            <div>
              <p class="text-gray-600 text-sm mb-3 font-medium">Item Type</p>

              <!-- Borrowable Item -->
              <div class="mb-3">
                <div
                  :class="[
                    'border-2 rounded-lg px-4 py-3 cursor-pointer transition-all',
                    selectedItemType === 'borrowable'
                      ? 'border-blue-500 bg-blue-50'
                      : 'border-gray-300 bg-white hover:border-gray-400',
                  ]"
                  @click="selectedItemType = 'borrowable'"
                >
                  <div class="flex items-center gap-3">
              ...
              <div class="mb-4">
                <div
                  ...
                  @click="selectedItemType = 'consumable'"
                >
                  <div class="flex items-center gap-3">
                    <div class="flex items-center relative">
                      <input
            ...
            <div>
              ...
              <div class="mb-3">
                <div
                  ...
                  @click="selectedBorrowerType = 'student'"
                >
                  <div class="flex items-center gap-3">
                    <div class="flex items-center relative">
                      <input
              ...
              <div class="mb-6">
                <div
                  :class="[
                    'border-2 rounded-lg px-4 py-3 cursor-pointer transition-all',
                    selectedBorrowerType === 'teacher'
                      ? 'border-blue-500 bg-blue-50'
                      : 'border-gray-300 bg-white hover:border-gray-400',
                  ]"
                  @click="selectedBorrowerType = 'teacher'"
                >
                  <div class="flex items-center gap-3">
                    <div class="flex items-center relative">
                      <input
            ...
            <button
              @click="navigateToQuickBorrowing"
              :disabled="!selectedItemType || !selectedBorrowerType"
              :class="[
                'w-full py-2 rounded-md text-white font-medium cursor-pointer transition-colors',
                selectedItemType && selectedBorrowerType
...
import LatestItemsSkeleton from "~/components/skeleton/latestItemsSkeleton.vue";
definePageMeta({
  title: "Dashboard",
});
...
const navigateToQuickBorrowing = () => {
...
const donutSeries = ref([1]); // Initialize with 1 to show empty chart placeholder
      ...
      donut: {
        ...
        labels: {
          ...
          total: {
            ...
            fontWeight: 600,
            formatter: (w) =>
              w.globals.seriesTotals.reduce((a, b) => a + b, 0) + "x",
          },
        },
      },
    },
...
const getLastItems = async () => {
  ...
  loading.value = true;
  const response = await $fetch(
    `${url}/dashboard/admin-user/items-loans-history`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
const getMostBorrowed = async () => {
  try {
    ...
    loading.value = true;
    const response = await $fetch(
      `${url}/dashboard/admin-user/most-borrowed-percentage`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
