<template>
  <div>
    ...
    <div class="flex items-center justify-between mt-12 mb-4">
      ...
      <SearchBox text="Search borrowed items..." />
    </div>
  </div>
      ...
      >
        ...
        >
          <div class="grid grid-cols-2 gap-4 w-full p-2">
            ...
            <InputText
              label="Borrowed Date"
              :placeholder="selectedItem.addedDate || '-'"
              disabled="true"
            />

            <InputText
              label="Borrower's Name"
              :placeholder="selectedItem.borrowerName || '-'"
              disabled="true"
            />
            <InputText
              label="Borrower's NIS"
              :placeholder="selectedItem.nis || '-'"
              disabled="true"
            />

            <InputText
              label="Borrower's Rombel"
              :placeholder="selectedItem.rombel || '-'"
              disabled="true"
            />
            <InputText
              label="Borrower's Rayon"
              :placeholder="selectedItem.rayon || '-'"
              disabled="true"
            />

            <InputText
              label="Borrower's Room"
              :placeholder="selectedItem.room || '-'"
              disabled="true"
            />
            <InputText
              label="Guarantee"
              :placeholder="selectedItem.guarantee || '-'"
              disabled="true"
            />
